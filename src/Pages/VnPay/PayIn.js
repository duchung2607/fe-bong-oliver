...
function PayIn() {
    ...
    const fetchData = async () => {
        ...
        setWait(true)
        try {
            var res = await checkPayIn(queryString)
            console.log(res)
            setData(res?.data)
        } catch (e) {
            console.log(e)
                ...
                data?.code == 200 ?
                    <div className='payment-success'>
                        ...
                        <div style={{ marginTop: "20px", display: "flex", justifyContent: "center" }}>
                            <Link to={"/my-walet/"} className="button back">Trở lại</Link>
                        </div>
                    </div>
                    :
                    <div className='payment-error'>
                        ...
                        <Link to="/my-walet" className="button">Trở lại</Link>
                    </div>
            }
        </div>
    )
